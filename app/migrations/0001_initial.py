    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipe', models.CharField(choices=[('gestion', 'gestion'), ('vente', 'vente')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.CharField(blank=True, max_length=8124)),
                ('client_associe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.clients')),
